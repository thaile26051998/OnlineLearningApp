...
const Profile = (props) => {
            ...
            data: [
                {
                    ...
                    paths: [{
                        title: "Paths in JavaScript",
                        data: [
                            {
                                name: "Design Pattern in JavaScript",
                                number: 6,
                    ...
                    authors: [{
                        title: "Top authors in JavaScript",
                        data: [
                            {
                ...
                },
                {
                    ...
                    paths: [{
                        ...
                        {
                            name: "Android Core Language",
                            number: 9,
                            uri: "https://i.ya-webdesign.com/images/golang-vector-5.png"
                        },
                        {
                            name: "Design Pattern in Android",
                            number: 16,
                            uri: "https://upload.wikimedia.org/wikipedia/commons/thumb/7/7a/C_Sharp_logo.svg/225px-C_Sharp_logo.svg.png"
                        },
                        {
                ...
                },
                {
                    ...
                    paths: [{
                        ...
                        {
                            name: "Angular Core Language",
                            number: 29,
                            uri: "https://i.ya-webdesign.com/images/golang-vector-5.png"
                        },
                        {
                            name: "Design Pattern in Angular",
                            number: 26,
                            uri: "https://upload.wikimedia.org/wikipedia/commons/thumb/7/7a/C_Sharp_logo.svg/225px-C_Sharp_logo.svg.png"
                        },
                        {
    ...
    return (
        <View style={styles.profileContainer}>
            ...
            <SectionSkills skills={profiles[0].skills[0]} navigation={props.navigation} />
            <SectionProfileInfo profiles={profiles[0]} />
        </View>
    )
}
